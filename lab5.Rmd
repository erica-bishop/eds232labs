...
```{r knn_wf}
#specify model
knn_spec <- nearest_neighbor(neighbors = tune()) |> #use tune to find optimal number of neighbors
  set_engine("kknn") |> 
...
```{r knn_tune}
# Fit the tuned and resampled workflow on our predefined folds and hyperparameters
...
rand_spec <- rand_forest(
  ...
  set_engine("ranger") |> #based on google ranger seems like a good engine to use for parallelization?
  set_mode("classification")
