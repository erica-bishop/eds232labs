...
#can encode before or after you split the data - doesn't matter
...
#MonthlyIncome
model1 <- glm(data = churn_train, Attrition ~ MonthlyIncome, family = binomial) #simple lpogistic regression
